...
import { User, Mail, Lock, Bell, MessageCircle, Upload, Save, Phone, Building, CreditCard, Download } from "lucide-react";
...
export default function SettingsPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    bio: "Looking for professional web development and design services",
  });
            ...
            {activeTab === "profile" && (
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <button className="flex items-center gap-2 px-4 py-2 bg-white/10 border border-white/10 rounded-lg hover:bg-white/20 transition-colors mb-2">
                ...
                <form onSubmit={handleSave} className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={4}
                      className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none"
                      placeholder="Tell us about your business and what services you're interested in..."
                    />
                  </div>
